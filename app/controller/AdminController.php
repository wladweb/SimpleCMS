	...
	class AdminController extends IController{
		...
		public function updateAction(){
			...
			if($_SERVER['REQUEST_METHOD'] === 'POST'){
				$this->do_true_action(self::MBloginfo, 'update_blog_info', array($_POST['blogname'],$_POST['blogdesc'],$_POST['blogauthor'],$_POST['authormail'],$_POST['templ'],$_POST['pagination']));
