...
class PostsController extends IController {
    ...
    public function indexAction() {
        ...
        $this->count_data = $this->do_true_action(self::MBloginfo,
                'get_menu_count_data');
        $this->cats = $this->do_true_action(self::MCategory,
                'get_all_categories');
    ...
    public function addAction() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $r = $this->do_true_action(self::MPosts, 'add_post',
                    array($title, $subtitle, $img, $cat, $content, $author, $ctime));
            if ($r) {
    ...
    public function delAction() {
        $this->is_admin();
        $r = $this->do_true_action(self::MPosts, 'delete_post',
                array($this->params['pid']));
        $this->do_true_action(self::MComments, 'delete_comments_by_post',
                array($this->params['pid']));
        if ($r) {
    ...
    public function updateAction() {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $r = $this->do_true_action(self::MPosts, 'update_post',
                    array($pid, $title, $subtitle, $category, $img, $content));
            if ($r) {
